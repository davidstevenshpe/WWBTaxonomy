...
<fmt:message var="removeInvalidReferencesTitle" key="uddi.report.removeInvalidReferences" bundle="${l10n}"/>
...
<c:choose>
    ...
    <c:otherwise>
        <syswf:block className="UI Block Common">
            <syswf:component name="/widgets/removeKeyedReferences" prefix="removeKeyedReferences">
                <syswf:param name="openRemoveKeyedReferencesDialog" value="__openRemoveKeyReferencesDialog" /> 
                <syswf:param name="winTitle" value="${removeInvalidReferencesTitle}" />
                <syswf:param name="registryBean" value="${registryBean}"/>
            </syswf:component>
            <div class="webfw-Window" id="${prefix}-webfw-Window">
	            <syswf:component name="/core/table" prefix="table">
	                <syswf:param name="customizationId" value="integration.uddi.report.properties.uddiExportReport"/>
