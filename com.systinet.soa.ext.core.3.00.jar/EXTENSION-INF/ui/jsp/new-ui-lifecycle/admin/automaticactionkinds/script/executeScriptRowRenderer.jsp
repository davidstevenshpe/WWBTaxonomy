    ...
    <table class="UI Table Properties">
        ...
        <tr>
            ...
            <td>
                ...
                <strong>${ApplyWhenLabel}:</strong> ${actionBean.eventDescriptor}
                </p>
                <p class="Comment Plain">
                <strong>Script location:</strong> <c:choose><c:when test="${empty actionBean.scriptName}">Undefined</c:when><c:otherwise>${actionBean.scriptName}</c:otherwise></c:choose>
                </p>
                <c:if test="${not empty actionBean.environmentSetup}">
                <p class="Comment Plain">
                <strong>Additional environment code:</strong><br/><code>${actionBean.environmentSetup}</code>
                </p>
                </c:if>
            </td>
        </tr>
