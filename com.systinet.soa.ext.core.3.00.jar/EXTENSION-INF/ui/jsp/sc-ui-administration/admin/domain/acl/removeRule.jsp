...
<fmt:message var="dialog_title" key="removeRule.header.label" bundle="${domain_Messages}"/>
<fmt:message var="message" key="removeRule.confirm.label" bundle="${domain_Messages}"/>
