...
<fmt:message var="dialog_title" key="removeMembersRole.header.label" bundle="${domain_Messages}"/>
<fmt:message var="message" key="removeMembersRole.confirm.label" bundle="${domain_Messages}"/>
