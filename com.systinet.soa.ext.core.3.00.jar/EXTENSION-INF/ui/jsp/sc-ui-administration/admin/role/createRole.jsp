...
<fmt:message key="create.title" var="title" bundle="${roleMsg}" />
<fmt:message key="create.subtitle" var="subtitle" bundle="${roleMsg}" />
<fmt:message key="create.save" var="save" bundle="${roleMsg}" />
<fmt:message key="create.cancel" var="cancel" bundle="${roleMsg}" />
<fmt:message key="create.save.hint" var="savehint" bundle="${roleMsg}" />
<fmt:message key="create.cancel.hint" var="cancelhint" bundle="${roleMsg}" />
