...
<fmt:message var="title" key="manageRenderers.title" bundle="${bundle}"/>
...
<syswf:block className="UI Block Common">
    <syswf:component name="/core/impl/customization/editors/relationRenderersCustomizationEditor" prefix="${viewId}.manageRelationRenderers" />
</syswf:block>