        ...
        <tr>
            ...
            <td>
                <c:if test="${not empty actionBean.deployToEnvironment}">
                    <p class="Comment Plain"><strong>Affected env.:</strong> ${actionBean.deployToEnvironment}</p>
                </c:if>
                <p class="Comment Plain"><strong>Affected servers:</strong> ${actionBean.deployTo}</p>
                <p class="Comment Plain"><strong>Deploy previously undeployed contracts:</strong> ${actionBean.deployPreviouslyUndeployed}</p>
            </td>
        </tr>
    </table>
</div>
